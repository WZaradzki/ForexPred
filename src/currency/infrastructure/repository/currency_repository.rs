...
use crate::{shared::infrastructure::{repository::database::DBPool, db_schema::schema::currencies}, currency::{application::validator::create_currency_validator::CurrencyCreateValidator, domain::entity::currency::Currency}};
...
impl CurrencyRepository {
    ...
    pub fn create_currency(&self, currency: Currency) -> Result<Currency, Error> {
